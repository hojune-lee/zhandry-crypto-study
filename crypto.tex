...
\begin{tcolorbox}[colback=yellow!10!white,colframe=blue!75!white,title=Secure PRF]
...
We can't apply Hybrid Experiment method here sicne we need $2^{n(\lambda)}$ hybrid experiments, 
